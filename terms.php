...
<html>
  <head>
    ...
    <title>Saint Luna | Terms & Conditions</title>

    <link href="/css/style.css" rel="stylesheet" type="text/css" />
    <link href="/css/termsStyle.css" rel="stylesheet" type="text/css" />
  ...
  <body>
    <div class="page">
        ...
        <header class="header">
        <div class="container">
        <span class="logo">Terms and Conditions for Saint Luna Band Official Website</span>
        </div>
        </header>
        <div class="subnav">
        <div class="container">
        ...
        <li>
        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Saint Luna Band Official Website.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Saint Luna Band Official Website, accessible from <a href="https://saintluna.me" rel="external nofollow noopener" target="_blank">https://saintluna.me</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>By email: support@saintluna.me</li>
        </ul>
        </div>
        ...
        <footer>
        <div class="container">
        Terms and Conditions for Saint Luna Band Official Website
        </div>
        </footer>
